...
|:-------------|:-------------------------------------------------------------------------------------------------------------------------|:-----------------|
| 7am          | Check-in opens                                                                                                           |                  |
| 8am          | CFD Industry Perspectives                                                                                                | Ray Humble       |
| 8:30am       | AI-driven multifidelity multidisciplinary design optimization (MF-MDO)                                                   | Ahmed Bayoumy    |
| 9:30am       | Break                                                                                                                    |                  |
| 10am         | Multi-Fidelity Uncertainty Quantification                                                                                | Markus Rumpfkeil |
| 11am         | Lunch break                                                                                                              |                  |
| 1pm          | Accelerating Uncertainty Quantification with Multifidelity Statistical Estimators: From Theory to Practice with PyApprox | John Jakeman     |
| 2pm          | Multifidelity Gaussian Process Modeling                                                                                  | Elizabeth Qian   |
| 3pm          | Break                                                                                                                    |                  |
| 4pm          | Panel                                                                                                                    |                  |
...
#### AI-driven Multifidelity Multidisciplinary Design Optimization (MF-MDO)
...
_Markus Rumpfkeil, University of Dayton_
...
#### Accelerating Uncertainty Quantification with Multifidelity Statistical Estimators: From Theory to Practice with PyApprox
