...
|:-------------|:------------------------------------------------------------------------------------------------------------------------------------|:-----------------|
| 7am          | Check-in opens                                                                                                                      |                  |
| 8am          | [Lecture 1: CFD Industry Perspectives](#lec1)                                                                                                | [Ray Humble](#humble)       |
| 8:30am       | [Lecture 2: AI-driven multifidelity multidisciplinary design optimization (MF-MDO)](#lec2)                                                   | [Ahmed Bayoumy](#bayoumy)    |
| 9:30am       | Break                                                                                                                               |                  |
| 10am         | [Lecture 3: Multi-Fidelity Uncertainty Quantification](#lec3)                                                                                | [Markus Rumpfkeil](#rumpfkeil) |
| 11am         | Lunch break                                                                                                                         |                  |
| 1pm          | [Lecture 4: Accelerating Uncertainty Quantification with Multifidelity Statistical Estimators: From Theory to Practice with PyApprox](#lec4) | [John Jakeman](#jakeman)     |
| 2pm          | [Lecture 5: Multifidelity Gaussian Process Modeling](#lec5)                                                                                  | [Elizabeth Qian](#qian)   |
| 3pm          | Break                                                                                                                               |                  |
...
#### <a name="lec1"></a>Lecture 1: CFD Industry Perspectives
...
##### <a name="humble"></a>Dr. Raymond A. Humble, Lockheed Martin Aeronautics
...
#### <a name="lec2"></a>Lecture 2: AI-driven Multifidelity Multidisciplinary Design Optimization (MF-MDO)
...
##### <a name="bayoumy"></a>Dr. Ahmed Bayoumy, Siemens Digital Industries Software
...
#### <a name="lec3"></a>Lecture 3: Multi-Fidelity Uncertainty Quantification 
...
##### <a name="rumpfkeil"></a>Dr. Markus Rumpfkeil, University of Dayton
...
#### <a name="lec4"></a>Lecture 4: Accelerating Uncertainty Quantification with Multifidelity Statistical Estimators: From Theory to Practice with PyApprox
...
##### <a name="jakeman"></a>Dr. John Davis Jakeman, Sandia National Laboratory
...
#### <a name="lec5"></a>Lecture 5: Multifidelity Gaussian Process Modeling 
...
##### <a name="qian"></a>Dr. Elizabeth Qian, Georgia Institute of Technology
...
* Lecture 5 [Notebook 1](https://colab.research.google.com/drive/19Ligua1UZwXH2lXjIlL4u9vwVdLuzCsJ), [Notebook 2](https://colab.research.google.com/drive/119XO6Z16sLGoGI0_ACmvRPgG2u2ZtIcX)
